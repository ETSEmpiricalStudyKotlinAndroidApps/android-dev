...
import com.example.sunflower.utilities.chooser
import com.example.sunflower.utilities.testPlant
import com.example.sunflower.workers.SeedDatabaseWorker
import com.google.samples.apps.sunflower.R.id
...
class PlantDetailFragmentTest {
    ...
    fun jumpToPlantDetailFragment() {
        ...
        composeTestRule.activityRule.scenario.onActivity { gardenActivity ->
            ...
            findNavController(activity, id.nav_host).navigate(id.plant_detail_fragment, bundle)
        }
    }
    ...
    fun testShareTextIntent() {
        val shareText = activity.getString(string.share_text_plant, testPlant.name)

        Intents.init()
        onView(withId(id.action_share)).perform(click())
        intended(
            chooser(
                allOf(
