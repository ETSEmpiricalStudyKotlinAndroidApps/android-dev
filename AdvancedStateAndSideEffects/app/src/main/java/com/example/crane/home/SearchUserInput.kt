...
fun PeopleUserInput(
    ...
    Column {
        ...
        CraneUserInput(
            ...
            vectorImageId = drawable.ic_person,
            tint = tint.value,
            onClick = {
...
@Composable
fun FromDestination() {
    CraneUserInput(text = "Seoul, South Korea", vectorImageId = drawable.ic_location)
}
...
fun ToDestinationUserInput(onToDestinationChanged: (String) -> Unit) {
    ...
    CraneEditableUserInput(
        ...
        caption = "To",
        vectorImageId = drawable.ic_plane
    )
...
fun DatesUserInput() {
    CraneUserInput(
        ...
        text = "",
        vectorImageId = drawable.ic_calendar
    )
}
