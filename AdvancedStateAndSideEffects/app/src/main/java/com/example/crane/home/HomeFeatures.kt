...
import androidx.compose.samples.crane.R.drawable
...
fun SleepSearchContent(onPeopleChanged: (Int) -> Unit) {
    CraneSearch {
        ...
        DatesUserInput()
        Spacer(Modifier.height(8.dp))
        SimpleUserInput(caption = "Select Location", vectorImageId = drawable.ic_hotel)
    }
}
...
fun EatSearchContent(onPeopleChanged: (Int) -> Unit) {
    CraneSearch {
        ...
        DatesUserInput()
        Spacer(Modifier.height(8.dp))
        SimpleUserInput(caption = "Select Time", vectorImageId = drawable.ic_time)
        Spacer(Modifier.height(8.dp))
        SimpleUserInput(caption = "Select Location", vectorImageId = drawable.ic_restaurant)
    }
}
