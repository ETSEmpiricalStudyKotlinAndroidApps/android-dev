package com.example.happybirthday.inventory
...
import com.example.happybirthday.InventoryActivity
...
class DataTransactionTests {
    @get:Rule
    val scenario = ActivityScenarioRule(InventoryActivity::class.java)
