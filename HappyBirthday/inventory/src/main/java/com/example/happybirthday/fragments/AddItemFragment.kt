...
import com.example.happybirthday.InventoryApplication
import com.example.happybirthday.data.Item
import com.example.happybirthday.viewmodel.InventoryViewModel
import com.example.happybirthday.viewmodel.InventoryViewModelFactory
...
class AddItemFragment : Fragment() {
    ...
    private fun addNewItem() {
        if (isEntryValid()) {
            ...
            Snackbar.make(requireView(), "Please provide the information!", Snackbar.LENGTH_SHORT).show()
        }
    }
